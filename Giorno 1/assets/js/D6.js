...
const paroleConcatenate = (primiDueCaratteri + ultimiTreCaratteri).toUpperCase();
console.log(paroleConcatenate);
...
function generaArrayCasuale() {
  ...
  return arrayCasuale;
}console.log(generaArrayCasuale());
/* ESERCIZIO 3 (filter)
  Scrivi una funzione per ricavare solamente i valori PARI da un array composto da soli valori numerici
*/

function cercaValoriPari(numeri){
  const valoriPari = numeri.filter(numero => numero% 2=== 0);
  return valoriPari;
}
arrayNumeri =[ 1,2,3,4,5,6];
valoriPari = cercaValoriPari(arrayNumeri);
console.log(valoriPari);
//arrayNumeri =[ 10,2,3,4,5,6];
//const ricavaPari = (array)=>{
  //return array.filter((el)=>el % 2 ===0);
//} console.log(ricavaPari(arrayNumeri));
/* ESERCIZIO 4 (forEach)
...
const risultato = sommaNumeri(arrayNumeri);
console.log(risultato);
/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
const somm = arrayNumeri.reduce(function(totale,ammontare){
return totale+ammontare;
});
console.log(somm);
/* ESERCIZIO 6 (map)
...
//}; console.log(lunghezza(arrayDiStringhe));
...
*/
const soloMillennio = (array) => {
  return array.filter((movie) => {
    return parseInt(movie.Year) > 1999
  });
}
console.log('es 12');
console.log(soloMillennio(movies));
/* ESERCIZIO 13 (reduce)
